...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.yata.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".yata" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".yata")
	}
